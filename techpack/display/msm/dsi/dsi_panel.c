...
//		goto error;
//	}
	dfps_caps->dfps_list_len = 8;

	dfps_caps->dfps_list = kcalloc(dfps_caps->dfps_list_len, sizeof(u32),
			GFP_KERNEL);
	dfps_caps->dfps_list[0] = 144;
	dfps_caps->dfps_list[1] = 130;
	dfps_caps->dfps_list[2] = 120;
	dfps_caps->dfps_list[3] = 90;
        dfps_caps->dfps_list[4] = 75;
        dfps_caps->dfps_list[5] = 60;
        dfps_caps->dfps_list[6] = 50;
        dfps_caps->dfps_list[7] = 30;
