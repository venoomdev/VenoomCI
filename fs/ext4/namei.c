...
/*
 * Probe for a drectory leaf block to search.
 *
...
int ext4_orphan_del(handle_t *handle, struct inode *inode)
{
	...
	struct ext4_inode_info *ei = EXT4_I(inode);
	struct ext4_sb_info *sbi = EXT4_SB(inoi_sb);
	__u32 ino_next;
	struct ext4_iloc iloc;
	int err = 0;
		       ...
		       unsigned int flags)
{
	 ...
	 *  and merrily kill the link to whatever was created under th
